module MultiItemContractx
  class Contract < ActiveRecord::Base
    ...
    attr_accessible :contract_date, :contract_num, :contract_on_file, :contract_info, :contract_total, :customer_id, :customer_signed_by, :sales_id, :tax, :customer_po,
                    ...
                    :as => :role_new
    attr_accessible :contract_date, :contract_num, :contract_on_file, :contract_info, :contract_total, :customer_id, :customer_signed_by, :tax, :customer_po, :sales_id,
    ...
    attr_accessor :start_date_s, :end_date_s, :customer_id_s, :zone_id_s, :paid_out_s, :sales_id_s, :contract_num_s, :wf_state_s, :customer_po_s,
                  :signed_s, :signed_by_id_s, :sign_date_s, :contract_on_file_s, :time_frame_s, :item_id_s
    ...
    attr_accessible :start_date_s, :end_date_s, :customer_id_s, :zone_id_s, :paid_out_s, :sales_id_s, :payment_agreement_s, :contract_num_s, :customer_po_s,
                  :signed_s, :signed_by_id_s, :sign_date_s, :sales_id_s, :contract_on_file_s, :time_frame_s, :wf_state_s, :item_id_s,
